...
#------------------------------------
newfile=$(grep logitechmediaserver_7.9.0~.........._amd64.deb ./index.html?ver=7.9 | cut -c42-87)
oldfile=$(ls | grep logitechmediaserver_7.9.0~.........._amd64.)
...
then
	...
	download=$(grep logitechmediaserver_7.9.0~.........._amd64.deb ./index.html?ver=7.9 | cut -c27-87)
	wget http://downloads.slimdevices.com/nightly/$download
	sudo su
	read
	service logitechmediaserver stop
	install=$(ls | grep logitechmediaserver_7.9.0~.........._amd64.deb)
	dpkg -i $install
