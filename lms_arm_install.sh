...
#------------------------------------
newfile=$(grep logitechmediaserver_7.9.0~.........._arm.deb ./index.html?ver=7.9 | cut -c42-85)
oldfile=$(ls | grep logitechmediaserver_7.9.0~.........._arm.deb)
...
then
	...
	download=$(grep logitechmediaserver_7.9.0~.........._arm.deb ./index.html?ver=7.9 | cut -c27-85)
	wget http://downloads.slimdevices.com/nightly/$download
	sudo su
	read
	service logitechmediaserver stop
	install=$(ls | grep logitechmediaserver_7.9.0~.........._arm.deb)
	dpkg -i $install
